"""
Base settings for GitHub Analyzer.
"""
...
EXPORT_MAX_FILE_SIZE = 50 * 1024 * 1024  # 50MB
EXPORT_ALLOWED_FORMATS = ['xlsx', 'csv', 'json']

# Analysis settings
ANALYSIS_RATE_LIMIT_PER_USER = 5  # concurrent tasks
ANALYSIS_RATE_LIMIT_PER_HOUR = 20  # per user per hour
ANALYSIS_DEFAULT_TIMEOUT = 300  # 5 minutes
